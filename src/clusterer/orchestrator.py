"""
ClusteringOrchestrator - Backend orchestrator for dashboard
Handles all business logic: data loading, clustering, LLM, metadata, DB operations
Dashboard is UI-only and delegates everything to this class
"""
...
class ClusteringOrchestrator:
    """
    Orchestrates all clustering operations:
    - Database management
    ...
    def __init__(self):
        ...
        self._init_database()
        print(f"[ClusteringOrchestrator] LLM Mode: {self.llm_mode}")
