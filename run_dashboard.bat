@echo off
REM Start Transaction Fraud Detection Dashboard
...
echo   CSV:  src\clusterer\data\transactions\transactions.csv
echo   JSON: src\clusterer\data\transactions\transactions_additional.json
echo.
echo Config File:
